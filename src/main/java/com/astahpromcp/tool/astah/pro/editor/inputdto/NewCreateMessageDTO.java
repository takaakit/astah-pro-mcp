...
public record NewCreateMessageDTO(
    ...
    @JsonPropertyDescription("New create message name. '()' is appended to the message name when it is displayed. Therefore, it is not necessary to add '()' at the end of the message name. Set this to an empty string when the create message has no name.")
