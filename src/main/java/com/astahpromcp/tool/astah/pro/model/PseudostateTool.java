...
import com.astahpromcp.tool.astah.pro.model.outputdto.PseudostateDTOAssembler;
...
public class PseudostateTool implements ToolProvider {
    ...
    public PseudostateTool(ProjectAccessor projectAccessor, ITransactionManager transactionManager, AstahProToolSupport astahProToolSupport) {
