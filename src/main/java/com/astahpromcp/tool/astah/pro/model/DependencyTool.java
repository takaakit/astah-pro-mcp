...
public class DependencyTool implements ToolProvider {
    ...
    public DependencyTool(ProjectAccessor projectAccessor, TransactionSupport transactionSupport, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
