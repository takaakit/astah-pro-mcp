...
import com.astahpromcp.tool.astah.pro.model.outputdto.LifelineLinkDTOAssembler;
...
//   https://members.change-vision.com/javadoc/astah-api/10_1_0/api/en/doc/javadoc/com/change_vision/jude/api/inf/model/ILifelineLink.html
@Slf4j
public class LifelineLinkTool implements ToolProvider {
    ...
    public LifelineLinkTool(ProjectAccessor projectAccessor, ITransactionManager transactionManager, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
    ...
    public List<ToolDefinition> createToolDefinitions() {
        try {
            ...
            log.error("Failed to create lifeline link tools", e);
            return List.of();
        }
    }
