...
public class LifelineLinkTool implements ToolProvider {
    ...
    public LifelineLinkTool(ProjectAccessor projectAccessor, TransactionSupport transactionSupport, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
