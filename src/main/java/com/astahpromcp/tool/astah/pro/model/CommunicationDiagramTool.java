...
import com.astahpromcp.tool.astah.pro.model.outputdto.CommunicationDiagramDTOAssembler;
...
public class CommunicationDiagramTool implements ToolProvider {
    ...
    public CommunicationDiagramTool(ProjectAccessor projectAccessor, ITransactionManager transactionManager, AstahProToolSupport astahProToolSupport) {
