...
//   https://members.change-vision.com/javadoc/astah-api/11_0_0/api/en/doc/javadoc/com/change_vision/jude/api/inf/model/IERModel.html
@Slf4j
public class ERModelTool implements ToolProvider {
    ...
    public ERModelTool(ProjectAccessor projectAccessor, ITransactionManager transactionManager, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
    ...
    public List<ToolDefinition> createToolDefinitions() {
        try {
            ...
            log.error("Failed to create ER model tools", e);
            return List.of();
        }
    }
