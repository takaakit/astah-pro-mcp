...
public class ERPackageTool implements ToolProvider {
    ...
    public ERPackageTool(ProjectAccessor projectAccessor, TransactionSupport transactionSupport, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
