...
import com.astahpromcp.tool.astah.pro.model.outputdto.TestCaseDTOAssembler;
...
public class TestCaseTool implements ToolProvider {
    ...
    public TestCaseTool(ProjectAccessor projectAccessor, ITransactionManager transactionManager, AstahProToolSupport astahProToolSupport) {
