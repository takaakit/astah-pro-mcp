...
import com.astahpromcp.tool.astah.pro.model.outputdto.EnumerationDTOAssembler;
...
public class EnumerationTool implements ToolProvider {
    ...
    public EnumerationTool(ProjectAccessor projectAccessor, ITransactionManager transactionManager, AstahProToolSupport astahProToolSupport) {
