...
public class CommentTool implements ToolProvider {
    ...
    public CommentTool(ProjectAccessor projectAccessor, TransactionSupport transactionSupport, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
