...
public class AssociationClassTool implements ToolProvider {
    ...
    public AssociationClassTool(ProjectAccessor projectAccessor, TransactionSupport transactionSupport, AstahProToolSupport astahProToolSupport, boolean includeEditTools) {
