...
public class RequirementDiagramGuideToolTest {

    private RequirementDiagramGuideTool tool;
    private Method getGuide;

    @BeforeEach
    void setUp() throws Exception {
        // Tool
        tool = new RequirementDiagramGuideTool();

        // getGuide() method
        getGuide = TestSupport.getAccessibleMethod(
            RequirementDiagramGuideTool.class,
            "getGuide",
